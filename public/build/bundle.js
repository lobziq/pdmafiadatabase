...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			a0 = element("a");
    			a0.textContent = "Игроки";
    			t1 = space();
    			a1 = element("a");
    			a1.textContent = "Игры";
    			t3 = space();
    			a2 = element("a");
    			a2.textContent = "Сеттинги";
    			t5 = space();
    			a3 = element("a");
    			a3.textContent = "👁️";
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "navbar-item");
    			add_location(a0, file$3, 7, 12, 190);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "navbar-item");
    			add_location(a1, file$3, 8, 12, 245);
    			attr_dev(a2, "href", "settings");
    			attr_dev(a2, "replace", "");
    			attr_dev(a2, "class", "navbar-item");
    			add_location(a2, file$3, 9, 12, 299);
    			attr_dev(a3, "href", "/");
    			attr_dev(a3, "class", "navbar-item");
    			add_location(a3, file$3, 10, 12, 381);
    			attr_dev(div, "class", "navbar-menu align-center");
    			add_location(div, file$3, 6, 8, 138);
    			attr_dev(nav, "class", "navbar");
    			attr_dev(nav, "aria-label", "main navigation");
    			add_location(nav, file$3, 5, 4, 79);
    			add_location(main, file$3, 4, 0, 67);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = action_destroyer(link.call(null, a2));
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 12, 1, 263);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$2, 14, 12, 307);
    			add_location(p, file$2, 13, 1, 290);
    			add_location(main, file$2, 11, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Home_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { name: 0, url: 1 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Settings Component";
    			add_location(h1, file$1, 12, 4, 266);
    			add_location(main, file$1, 11, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Settings_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { name: 0, url: 1 });
    		...
    		if (/*name*/ ctx[0] === undefined && !('name' in props)) {
    			console.warn("<Settings> was created without expected prop 'name'");
    		}
    	}
    ...
    function create_default_slot(ctx) {
    	...
    	route0 = new Route({
    			props: { path: "/", component: Home_1 },
    			$$inline: true
    		});

    	route1 = new Route({
    			props: { path: "settings", component: Settings_1 },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 11, 1, 248);
    		},
    		m: function mount(target, anchor) {
